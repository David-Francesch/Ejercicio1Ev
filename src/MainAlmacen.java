...
// Un monstruo come un número de galletas aleatorio, entre 1 y 10 (pero para cada monstruo, el número es fijo). Si el número es mayor que las galletas que quedan se comerá todas las que estén disponibles.
